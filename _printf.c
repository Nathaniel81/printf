 ...
 * @fmt_info: The format information parameters read
 */
...
/**
 * _putstr - adds the specified string to the buffer
 * @str: The string input to write
 * Return: 1 on success.
...
/**
 * write_to_buffer - Based on an action code, writes a char to the buffer.
