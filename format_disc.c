...
/**
 * new_format_info - Creates and initializes a new format info structure.
 ...
 * @exponent_size: The number of bits in the exponent passed
 * @mantissa_size: The number of bits in the mantissa passed
