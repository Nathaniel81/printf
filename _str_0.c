...
/**
 * mem_set - Fills a portion of a string with a supplied
 * character beginning at position 0.
 * @str: The string passed containing the section to be filled
 * @n: The length input of the section to fill
 * @c: The character passed to fill the section with
 */
