 ...
 * @is_long_long: Indicates the presence of the 'll' length modifier
 * @is_long: Indicates the presence of the 'l' length modifier
 * @is_short: Specifies if the 'h' length modifier is present.
 * @is_char: Specifies if the 'hh' length modifier is present.
 ...
 * @space: Specifies the presence of the ' ' flag
 * @left: Specifies the presence of the '-' flag
 * @show_sign: indicates the presence of the '+' flag
 * @dg_sp: The current locale's digit separator for integers
...
/**
 * struct spec_printer - Represents a function
 * that prints an argument in a certain format.
...
/**
 * struct float_info - Represents the Floating-Point Arithmetic (IEEE 754)
 * specification of a float
