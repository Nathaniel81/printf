...
#include "main.h"
/**
 * round_float_to_int - Rounds a floating point number to an int
 * @num: The floating point number to be rounded
 * @len: The length of the floating-point number passed
 * @dec_pos: The decimal point location in a floating point number
 * @frac_len: The length of the fractional part in the floating point number
 * Return: The int, otherwise NULL
 */
 ...
 * @num: The floating point number passed to round
